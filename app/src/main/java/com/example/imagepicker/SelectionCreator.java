...
import com.example.imagepicker.engine.ImageEngine;
import com.example.imagepicker.filter.Filter;
import com.example.imagepicker.internal.entity.CaptureStrategy;
import com.example.imagepicker.internal.entity.SelectionSpec;
import com.example.imagepicker.listener.OnCheckedListener;
import com.example.imagepicker.listener.OnSelectedListener;
import com.example.imagepicker.ui.MatisseFragment;
...
public final class SelectionCreator {
     ...
     * 1. com.example.imagepicker.R.style.Matisse_Zhihu;
     * 2. com.example.imagepicker.R.style.Matisse_Dracula
     * you can define a custom theme derived from the above ones or other themes.
     *
     * @param themeId theme resource id. Default value is com.example.imagepicker.R.style.Matisse_Zhihu.
     * @return {@link SelectionCreator} for fluent API.
     */
     ...
     * @return {@link SelectionCreator} for fluent API.
     */
    public SelectionCreator addFilter(@NonNull GifSizeFilter filter) {
     ...
     * 1. {@link com.example.imagepicker.engine.impl.GlideEngine}
     ...
     */
    public void forResult(int requestCode, MainActivity context) {
...
//        if (fragment != null) {
            MatisseFragment matisseFragment = new MatisseFragment(context);
            context.getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.container, matisseFragment, MatisseFragment.class.getSimpleName())
