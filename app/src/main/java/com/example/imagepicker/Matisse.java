...
import com.example.imagepicker.ui.MatisseActivity;
...
public final class Matisse {
     ...
     * <p>
     * This Activity's {@link Activity#(int, int, Intent)} will be called when user
     * finishes selecting.
     *
     ...
     *
     * @param data Intent passed by {@link Activity#(int, int, Intent)} or
