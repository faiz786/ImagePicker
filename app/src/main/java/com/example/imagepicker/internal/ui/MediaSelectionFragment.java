...
import com.example.imagepicker.internal.ui.widget.MediaGridInset;
import com.example.imagepicker.internal.utils.UIUtils;
...
public class MediaSelectionFragment extends Fragment implements
    ...
    static MatisseFragment matisseFragment;

    public static MediaSelectionFragment newInstance(Album album, Boolean originalAvailable, MatisseFragment matisseFragmentContext) {
        MediaSelectionFragment fragment = new MediaSelectionFragment();
        Bundle args = new Bundle();
        args.putParcelable(EXTRA_ALBUM, album);
        args.putBoolean(EXTRA_RESULT_ORIGINAL_ENABLE, originalAvailable);
        matisseFragment = matisseFragmentContext;
...
//        if (context instanceof SelectionProvider) {
        mSelectionProvider = (SelectionProvider) matisseFragment;
//        } else {
...
//        if (context instanceof AlbumMediaAdapter.OnMediaClickListener) {
        mOnMediaClickListener = (AlbumMediaAdapter.OnMediaClickListener) matisseFragment;
//        }
    }
