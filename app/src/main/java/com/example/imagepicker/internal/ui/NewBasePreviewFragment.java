 ...
 */
public class NewBasePreviewFragment extends Fragment implements View.OnClickListener,
...
//    public static NewBasePreviewFragment newInstance(Bundle bundle, Boolean mOriginalEnable, int viewType) {
//        NewBasePreviewFragment fragment = new NewBasePreviewFragment();
//        Bundle args = new Bundle();
//        args.putBundle(NewBasePreviewFragment.EXTRA_DEFAULT_BUNDLE, bundle);
//        args.putBoolean(NewBasePreviewFragment.EXTRA_RESULT_ORIGINAL_ENABLE, mOriginalEnable);
//        args.putParcelable(NewBasePreviewFragment.EXTRA_ALBUM, bundle.getParcelable(EXTRA_ALBUM));
//        args.putParcelable(NewBasePreviewFragment.EXTRA_ITEM, bundle.getParcelable(EXTRA_ITEM));
...
//            bundle = getArguments().getBundle(NewBasePreviewFragment.EXTRA_DEFAULT_BUNDLE);
//            bundle = bundle.getBundle(NewBasePreviewFragment.EXTRA_DEFAULT_BUNDLE);
...
//            mOriginalEnable = getActivity().getIntent().getBooleanExtra(EXTRA_RESULT_ORIGINAL_ENABLE, false);
...
//        Bundle bundle = getActivity().getIntent().getBundleExtra(EXTRA_DEFAULT_BUNDLE);
...
//            Album album = getActivity().getIntent().getParcelableExtra(EXTRA_ALBUM);
            Album album = getArguments().getParcelable(EXTRA_ALBUM);
            mCollection.load(album);

//            Item item = getActivity().getIntent().getParcelableExtra(EXTRA_ITEM);
